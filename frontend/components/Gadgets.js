    ...
    <div className="p-4 bg-black text-white">
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full bg-gray-800 text-white placeholder-gray-400 rounded-full py-2 px-4 outline-none"
        />
      </div>
      ...
      <div className="bg-gray-900 rounded-xl p-4">
        ...
        {['User1', 'User2'].map((user, index) => (
          <div key={index} className="flex items-center space-x-3 py-2 hover:bg-gray-800">
            ...
            <button className="ml-auto bg-white text-black rounded-full px-4 py-1 hover:bg-gray-200">
              Follow
            </button>
          </div>
        ))}
